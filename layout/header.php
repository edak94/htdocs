                            ...
                            <div class="main-menu collapse navbar-collapse" id="navbarNavDropdown">
                                <ul  class="navbar-nav mr-auto">
                                    ...
                                    <li class="header-menu-column">
                                        <a href="boutique.php">OCCASIONS</a>
                                    </li>
                                    ...
                                    <li class="header-menu-column" <?php echo !isset($_SESSION["utilisateur"]) ? "style='display:none;'" : ""; ?>>
                                        <a href="admin/admin_voitures.php"><span style="color: red;">Panneau de contrôle</span></a>
                                    </li>
                                </ul>
                            </div>
                        </nav>
