...
$statuts = isset($_GET["statuts"]) ? $_GET["statuts"] : null;

$connexion = new mysqli ("localhost", "root", "root", "alex");
$query = 'SELECT * FROM `avisclient` ';
...
if($statuts != null){
    $filterQuery .= "Statut = ? AND ";
    array_push($filters, $statuts);
    $filterString .= "s";
}
        ...
        <form action="#" method="get">
            <div class="row">
                ...
                <div class="form-group col-md-3 col-sm-6">
                    ...
                    <input type="text" class="form-control" id="statuts" name="statuts" value="<?php echo $statuts?>">
                </div>
            </div>
    ...
    <div class="row">
        <table class="table">
            ...
            <tr>
                ...
                <td><span class="badge bg-<?php echo $row["Statut"] == "VALIDE" ? "primary" : "danger" ?>" ><?php echo $row["Statut"] ?></span></td>
                <td><a href="admin_avis_detail.php?id=<?php echo $row["Id"]; ?>"><i class="fa fa-edit"></i></a></td>
            </tr>
            <?php } ?>
            </tbody>
        </table>
