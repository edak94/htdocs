...
<script>
    ...
    function getVoiture(str) {
        if (str == "") {
            ...
            xmlhttp.open("GET", "admin_voiture_filtre.php?page=" + page, true);
            xmlhttp.send();
        } else {
            var xmlhttp = new XMLHttpRequest();
            xmlhttp.onreadystatechange = function () {
            ...
            xmlhttp.withCredentials = true;
            xmlhttp.open("GET", "admin_voiture_filtre.php?" + str + "&page=" + page, true);
            xmlhttp.send();
        }
    }
...
<div class="container-lg" style="display: <?php echo !isset($_SESSION["utilisateur"]) ? "none" : "" ?>">
    <div class="row" style="margin-top: 5px;">
        <button class="btn btn-warning" type="submit" data-toggle="modal" data-target="#addModal"><i class="fa fa-add"></i> Ajouter un véhicule</button>
    </div>
</div>
...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="AjouterVoiture" aria-hidden="true">
