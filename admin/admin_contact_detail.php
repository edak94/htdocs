...
$query = 'SELECT * FROM `formulairecontact` WHERE `Id` = ?';
...
<div class="container-lg">
    <div class="row">
        ...
        <div class="col-md-3">Prenom:<?php echo $avis["Prenom"] ?></div>
        <div class="col-md-3">Email:<?php echo $avis["Email"] ?></div>
        <div class="col-md-3">Télépgone:<?php echo $avis["Telephone"] ?></div>
        <div class="col-md-12"><?php echo $avis["FormulaireContactMessage"] ?></div>
    </div>
</div>
