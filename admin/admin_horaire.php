...
<div class="container-lg">
    <h2 class="text-center">Horaire du garage</h2>

    <form action="../enregistrement/enregistrement_horaire.php" method="POST">
        <div class="form-group">
            <label for="horaire">Horaire:</label>
            <textarea id="texte" class="form-control" name="texte" required><?php echo isset($horaire) ? $horaire["Texte"] : null;?></textarea>
        </div>
